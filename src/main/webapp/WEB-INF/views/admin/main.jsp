      ...
      <div class="top_gnb_area">
         <ul class="list">
            ...
            <c:if test="${member != null }">   <!-- 로그인 o -->      
               <c:if test="${member.adminChk == 1 }">   <!-- 관리자 계정 -->
         ...
         <div class="ls_wrap">
            ...
            <div class="ls_div">
               <c:forEach items="${ls}" var="ls">
                  <a href="/goodsDetail/${ls.gdsNum}">
                     <div class="ls_div_content_wrap">
                        <div class="ls_div_content">
                           <div class="image_wrap" data-gdsNum="${ls.imageList[0].gdsNum}" data-path="${ls.imageList[0].uploadPath}" data-uuid="${ls.imageList[0].uuid}" data-filename="${ls.imageList[0].fileName}">
                              <img>
                           </div>            
